...
/*    */ 
/*    */ public class ItemManaitaPickaxe
/*    */   extends ItemPickaxe
/*    */   implements IManaitaConfigurable
/*    */ {
/* 28 */   public static final Set<Material> MATERIALS = Sets.newHashSet((Object[])new Material[] { Material.field_151576_e, Material.field_151573_f, Material.field_151574_g, Material.field_151592_s, Material.field_151588_w, Material.field_151598_x });
/*    */   
/*    */   public ItemManaitaPickaxe() {
/* 31 */     super(ItemManaitaSword.MANAITA);
...
/* 50 */       boolean digUnderPlayer = nbt.func_74767_n(IManaitaConfigurable.EnumConfig.DIG_UNDER_PLAYER.func_176610_l());
/* 51 */       RayTraceResult traceResult = func_77621_a(world, player, false);
/* 52 */       if (traceResult != null)
/* 53 */         ManaitaPlusUtils.digArea(world, player, pos, traceResult, range, depth, digUnderPlayer, MATERIALS); 
/*    */     } 
/* 55 */     return true;
/*    */   }
/*    */   
/*    */   public void func_77663_a(ItemStack itemStack, World world, Entity entity, int slot, boolean isHolding) {
/* 59 */     ManaitaPlusUtils.setDefaultNBT(getConfigs(), itemStack);
/* 60 */     boolean editSilkTouch = itemStack.func_77942_o() ? itemStack.func_77978_p().func_74764_b(IManaitaConfigurable.EnumConfig.SILKTOUCH.func_176610_l()) : false;
/* 61 */     ManaitaPlusUtils.editEnchantment(itemStack, editSilkTouch);
/*    */   }
/*    */   
/*    */   public void setDamage(ItemStack itemStack, int damage) {
/* 65 */     super.setDamage(itemStack, 0);
/*    */   }
/*    */   
...
/* 75 */     ManaitaPlusUtils.setDefaultNBT(getConfigs(), itemStack);
/* 76 */     ManaitaPlusUtils.addNBTInformation(getConfigs(), itemStack, tooltip);
/*    */   }
/*    */   
/*    */   public List<IManaitaConfigurable.EnumConfig> getConfigs() {
/* 80 */     return new ArrayList<IManaitaConfigurable.EnumConfig>() {
/*    */       
/*    */       };
/*    */   }
/*    */ }
...
/* Location:              H:\mc 開發用\Manaita+Plus-1.12.2-1.0.1.zip!\rikuto\manaita_plus\item\ItemManaitaPickaxe.class
