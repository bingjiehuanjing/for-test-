...
/*    */ 
/*    */ public class GuiBrewingManaita
/*    */   extends GuiContainer {
/* 13 */   private static final ResourceLocation BREWING_STAND_GUI_TEXTURES = new ResourceLocation("textures/gui/container/brewing_stand.png");
/*    */   private int magnification;
/*    */   
/*    */   public GuiBrewingManaita(InventoryPlayer playerInv, World world, BlockPos pos, int doubling) {
/* 17 */     super(new ContainerBrewingManaita(playerInv, world, pos, doubling));
...
/* 30 */     this.field_146289_q.func_78276_b(this.magnification + "x", 108, 34, 4210752);
/*    */   }
/*    */   
/*    */   protected void func_146976_a(float partialTicks, int mouseX, int mouseY) {
/* 34 */     GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
/* 35 */     this.field_146297_k.func_110434_K().func_110577_a(BREWING_STAND_GUI_TEXTURES);
...
/*    */     
/* 40 */     int k = 18;
/* 41 */     func_73729_b(i + 60, j + 44, 176, 29, k, 4);
/*    */   }
/*    */ }


/* Location:              H:\mc 開發用\Manaita+Plus-1.12.2-1.0.1.zip!\rikuto\manaita_plus\gui\GuiBrewingManaita.class
